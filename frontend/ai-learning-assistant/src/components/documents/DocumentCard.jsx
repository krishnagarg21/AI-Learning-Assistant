...
const DocumentCard = ({ document, onDelete }) => {
  ...
  return (
    <div
      className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl hover:shadow-emerald-200/50 transition-all duration-300 flex-col justify-between cursor-pointer hover:-translate-y-1"
    ...
    >
      ...
      {/* Hover Indicator */}
      <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/0 to-teal-500/0 group-hover:from-emerald-500/5 transition-all duration-300 pointer-events-none" />
    </div>
  );
};
