...
const Button = ({
  ...
  const variantStyles = {
    primary: 'bg-linear-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25 hover:shadow-emerald-600 hover:to-teal-600 hover:shadow-xl hover:shadow-emerald-500/30',
